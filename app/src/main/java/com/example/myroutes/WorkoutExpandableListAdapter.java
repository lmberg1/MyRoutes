...
public class WorkoutExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public WorkoutExpandableListAdapter(Context context, List<List<BoulderItem>> expandableListDetail) {
    ...
    public View getGroupView(int listPosition, boolean isExpanded,
        ...
        TextView setText = convertView.findViewById(R.id.set_text);

        // Set information in each view
        String title = String.format(Locale.US, "Set %d:", listPosition + 1);
        String text = String.format(Locale.US, "Climb %d boulders of %s", info.size(), info.get(0).getBoulder_grade());
